...
if [ ! -f "/data/data/com.termux/files/usr/bin/ubuntu-lts18-lxde" ]; then
cat << "EOF" > /data/data/com.termux/files/usr/bin/ubuntu-lts18-lxde
#!/bin/bash
root="/data/data/com.termux/files/home/termux21-proot-script/ubuntu-lts18-lxde"
